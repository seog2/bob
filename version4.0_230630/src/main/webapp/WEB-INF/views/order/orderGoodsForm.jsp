...
function fn_show_order_detail(){
	...
	// payType 선택된 라이오 버튼 value 값이 있음.
		...
		(
			{
				...
				success : function(data, textStatus) 
				{
					...
					// form 에 있는 input box 데이터 변경
					// 인풋박스 name = ordr_idxx    value 값을 ordr_idxx 로 변경 ;
					$('input[name=ordr_idxx]').attr("value", ordr_idxx) ;
					$('input[name=good_name]').attr("value", good_name) ;
					$('input[name=good_mny]').attr("value", good_mny) ;
					$('input[name=buyr_name]').attr("value", buyr_name) ;
					$('input[name=site_cd]').attr("value", site_cd) ;	
