...
public class CustomerDAOImpl implements CustomerDAO {
	...
	//Review 23-06-28
	/*
	 * public List<ReviewVO> ReviewList(String startRowNum, String endRowNum) throws
	 * DataAccessException { ReviewVO reviewVO = new ReviewVO();
	 * reviewVO.setStartRowNum(startRowNum); reviewVO.setEndRowNum(endRowNum);
	 * 
	 * List<ReviewVO> reviewList =
	 * sqlSession.selectList("mapper.customer.ReviewList", reviewVO); return
	 * reviewList; }
	 * 
	 * public List selectReviewDetail(String review_id) throws DataAccessException{
	 * List
	 * selectReview=(List)sqlSession.selectList("mapper.customer.selectReviewDetail"
	 * ,review_id); return selectReview; }
	 */
