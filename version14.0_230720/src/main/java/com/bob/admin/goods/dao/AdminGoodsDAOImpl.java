package com.bob.admin.goods.dao;
...
public class AdminGoodsDAOImpl  implements AdminGoodsDAO{
	...
	@Override
	public List<GoodsVO>searchGoodsList(String keyword, boolean isNumericKeyword) throws DataAccessException {
		Map<String, Object> paramMap = new HashMap<String, Object>();
	    paramMap.put("keyword", keyword);
	    paramMap.put("isNumericKeyword", isNumericKeyword);
	    
		ArrayList<GoodsVO>  goodsList=(ArrayList)sqlSession.selectList("mapper.admin.goods.searchGoodsList",paramMap);
		return goodsList;
	}
