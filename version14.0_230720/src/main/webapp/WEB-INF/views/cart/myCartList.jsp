...
function updateCartGoodsQty(index) {
		...
		console.log(oldSalesPrice/9*10);

		var p_totalGoodsPrice=document.getElementById("p_totalGoodsPrice");
		var p_totalSalesPrice=document.getElementById("p_totalSalesPrice");
		var p_finalTotalPrice=document.getElementById("p_finalTotalPrice");
		
		var p_totalGoodsPriceText = p_totalGoodsPrice.innerText.replace("원","")
		...
		var total = cartGoodsQtyElement.parentNode.parentNode.children[6];
		
		var price = cartGoodsQtyElement.parentNode.parentNode.children[3].innerText.replace("원","");
		console.log(price);
		var salesPrice = cartGoodsQtyElement.parentNode.parentNode.children[4].innerText.replace("원(10%할인)","");
