			        	...
			        	<c:otherwise>
							...
							<c:set var="cart_id" value="${myCartList[cnt.count-1].cart_id}" />
					 		<tr>       
								...
								<td>
							   		<strong>
								      <fmt:formatNumber  value="${item.goods_sales_price*0.9}" type="number" var="discounted_price" />${discounted_price}원(10%할인)
							        </strong>
								</td>
								<td>
								...
								<td>
							   		<strong>
								    	<fmt:formatNumber  value="${item.goods_sales_price*0.9*cart_goods_qty}" type="number" var="total_sales_price" />${total_sales_price}원
									</strong>
								</td>
								<td class="mycart-btn">
