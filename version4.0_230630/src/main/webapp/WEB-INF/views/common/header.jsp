...
<nav class="navbar">
	<div class="navbar__logo">
        <a href="${contextPath}/main/main.do">
        	<i class="fa-solid fa-paw"></i>&nbsp;밥멍냥</a>
	</div>
	<c:choose>
	...
	<ul class="navbar__links">
	   <c:choose>
			...
			<c:otherwise>
				...
				<li><a href="${contextPath }/member/loginForm.do" onClick="alert('로그인 후 이용해주세요')"><i class="fa-solid fa-cart-shopping"></i></a></li>
				<li><a href=""><i class="fa-solid fa-bolt-lightning"></i></a></li>
			</c:otherwise>
		</c:choose>
