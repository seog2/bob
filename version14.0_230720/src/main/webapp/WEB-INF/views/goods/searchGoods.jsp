...
<div id="container">
	<div id="content">
		<div class="search-wrap">
			...
			<div id="new_book">
				<div id="left_scroll">
					<a href="javascript:void(0);" onclick="slide('left');"><img src="${contextPath}/resources/image/left.gif"></a>
				</div>
				...
				<div id="right_scroll">
					<a href="javascript:void(0);" onclick="slide('right');"><img src="${contextPath}/resources/image/right.gif"></a>
				</div>
