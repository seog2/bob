...
public class CustomerServiceImpl implements CustomerService {
    ...
    //REVIEW 23-06-28
	/*
	 * @Override public Map<String, List> ReviewList(String startRowNum, String
	 * endRowNum) throws Exception { Map<String, List> reviewMap = new
	 * HashMap<String, List>();
	 * 
	 ...
	 * return reviewMap; }
	 * 
	 * public List selectReviewDetail(String review_id) throws Exception{ return
	 * customerDAO.selectReviewDetail(review_id); }
	 */
