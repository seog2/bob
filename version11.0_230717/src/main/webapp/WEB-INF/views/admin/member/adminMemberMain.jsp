...
<div class="boardwrap">
    <div class="border-qna-wrap">
	    <div class="board-buttondiv">
	        <div>
                	<input class="board-btn btn1" onclick="location.href='addNewGoodsForm.do'" type="button" value="회원 삭제">
            </div>
            <div class="searchdiv">
		...
		<div>
			<table class="noticeAdmin-table">
				...
				<tr>
		        	<td class="noticeAdmin-td1"><input type="checkbox" name="notice_id" value="${item.member_id}"></td>
