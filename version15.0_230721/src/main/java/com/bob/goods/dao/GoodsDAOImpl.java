...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	public List<GoodsVO> allGoodsList(GoodsVO goodsVO) throws DataAccessException {
		List<GoodsVO> allGoodsList = (ArrayList)sqlSession.selectList("mapper.goods.allGoodsList",goodsVO);
		return allGoodsList;
	}
	
	
	@Override
	public List goodsReviewList(String goods_id) throws DataAccessException {
		List goodsReviewList = (List)sqlSession.selectList("mapper.goods.goodsReviewList",goods_id);
