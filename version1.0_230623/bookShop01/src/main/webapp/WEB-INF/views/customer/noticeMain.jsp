...
<link href="${contextPath}/resources/css/notice.css" rel="stylesheet" type="text/css">
    ...
    <div class="customerwrap">
        ...
        <div id="notice">
            <table class="customer-table">
                ...
                <tr class="table-tr" onclick="location.href='noticeDetail.do?notice_id=${ list.notice_id }'">
					...
					<div class="row">
		  			<ul class="pagination">
		    			...
		    			<li class="<c:if test="${ page == 1 } ">disabled</c:if>">
		    				<a href="/customer/noticeMain.do?page=${page-1}">&#60;</a>
		    			</li>
		    			...
		    			<li class="<c:if test="${ page == 5 }">disabled</c:if>">
		    				<a class="" href="/customer/noticeMain.do?page=${page+1}">&gt;</a>
		    			</li>
		  			</ul>
					</div>
				</div>
