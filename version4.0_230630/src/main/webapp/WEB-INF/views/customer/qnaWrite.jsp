    ...
    <div class="qnawrap">
        ...
        <div class="qnaediv">
            ...
            <div class="qna-title">
                ...
                <input type="text" name="qna_title" class="title">
                <c:forEach items="${goodsMap}" var="qna">
					    <c:if test="${not empty qna.goods_id}">
					        <input type="hidden" name="goods_id" value="${qna.goods_id}">
					    </c:if>
					</c:forEach>
            </div>
