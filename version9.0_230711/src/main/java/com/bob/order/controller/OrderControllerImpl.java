...
public class OrderControllerImpl extends BaseController implements OrderController {
	...
	public ModelAndView payToOrderGoods(@RequestParam Map<String, String> receiverMap,
		...
		System.out.println("데이터 확인2222 = " + resultMap.toString());
		...
		for(int i=0; i<myOrderList.size();i++){
			...
			orderVO.setReceiver_hp1(receiverMap.get("receiver_tel1"));
			orderVO.setReceiver_hp2(receiverMap.get("receiver_tel2"));
			orderVO.setReceiver_hp3(receiverMap.get("receiver_tel3"));
